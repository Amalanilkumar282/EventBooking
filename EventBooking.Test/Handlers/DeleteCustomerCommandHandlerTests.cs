...
namespace EventBooking.Test.Handlers
{
    public class DeleteCustomerCommandHandlerTests
    {
        ...
        public async Task Handle_Should_Call_Delete()
        {
            ...
            var handler = new DeleteCustomerCommandHandler(mockRepo.Object);

            var result = await handler.Handle(new DeleteCustomerCommand { Id = Guid.NewGuid() }, CancellationToken.None);
